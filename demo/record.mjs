...
//   npm run record              # writes demo/output/grail-demo.*
//   npm run record:all          # writes demo/output/variants/grail-<variant>.*
//
// Flags:
...
<html lang="en">
  <head>
    ...
    <title>Grail Demo Variants</title>
    <style>
...
async function main() {
  ...
  try {
    for (const v of selected) {
      const base = writeVariants ? `grail-${v.id}` : 'grail-demo';
